...
<head>
    ...
    <title>Create Invoice @rizkiagung.id</title>
    <!-- Fontawesome CSS CDN -->
...
<body>
    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Creator Invoice @rizkiagung.id</a>
        ...
        <div id="user-container" class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item fw-bold" href="./?action=logout"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
            </ul>
        </div>
    </div>
    </nav>
