...
<head>
    ...
    <title>Login | Invoice @rizkiagung.id</title>
    <!-- Fontawesome CSS CDN -->
...
<body class="login-page">
    <div class="page-title"><strong>Create Invoice @rizkiagung.id - Login </strong></div>
                ...
                <div class="container-fluid">
                    <form action="" method="POST">
                        ...
                        <div class="mb-3 w-100 d-flex justify-content-center">
                            <button class="btn btn-primary rounded-pill"><i class="fas fa-sign-in-alt"></i> Login</button>
                        </div>
                    </form>
                </div>
            </div>
